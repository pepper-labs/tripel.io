  ...
  return <div className={styles.container}>
    ...
    <main className={styles.main}>
      ...
      <div className={styles.content}>
        <ul>
          <li>
            <a href="/host-terms-and-conditions.pdf" target="_blank">
              2021. szeptember 25. után kötött szolgáltatói szerződésekre alkalmazandó Általános Szerződési Feltételek
              (hatályos: 2021. szeptember 25-től)
            </a>
          </li>
        </ul>
      </div>
